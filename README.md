...
- Шаг 1. Создать Go-проект и базовую структуру
- Шаг 2. Описать основные типы
- Шаг 3. Сделать NewGame
- Шаг 4. Добавить реестр карт
- Шаг 5. Добавить добор карт
- Шаг 6. Добавить ману
- Шаг 7. Добавить ApplyAction (ActionEndTurn)
- Шаг 8. Добавить spell-карту “урон боссу”
- Шаг 9. Добавить проверку победы
- Шаг 10. Добавить spell-карту лечения
- Шаг 11. Добавить ValidTargets
